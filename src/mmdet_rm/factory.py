...
from mmdet_rm.config.config_resource import MainConfig_PropertyManager
...
class MMDetection_RM_Factory:
    ...
    @cached_property
    def main_config_factory(self)->MainConfig_PropertyManager:
        return MainConfig_PropertyManager()