...
def test_task_record():
    ...
    config_record.property_manager.config_file_path = config_record.property_manager.dir_path/Path("config.py")
    ...
    task_record:TaskRecord = work_record.create_train_task(dataset_record.id, "model_1", 10)
    ...
    assert task_record.property_manager.mmdet_config_file_path == config_record.property_manager.config_file_path
