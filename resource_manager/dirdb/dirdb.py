...
from ..dirtree.name_id_manager import ID, NAME, Linked_ID_Name_Manager
from ..dirtree.dir_tree import DirTree
from ..dirtree.factory import DirTreeFacotry
...
class DirDB:
    ...
    @cached_property
    def name_managers(self)->List[Linked_ID_Name_Manager]:
    ...
    @cached_property
    def id_manager_dict(self)->Dict[ID, Linked_ID_Name_Manager]:
